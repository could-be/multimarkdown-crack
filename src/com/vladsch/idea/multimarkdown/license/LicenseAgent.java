...
public class LicenseAgent {
    private static final Logger LOG = Logger.getInstance("com.vladsch.idea.multimarkdown.license.agent");
...
//        return siteURL + productPrefixURL + "/buy";
        return buyPageURL;
    }
...
////                        }
////                    } catch (NoSuchPaddingException | IOException | InvalidKeySpecException | NoSuchAlgorithmException ignored) {
